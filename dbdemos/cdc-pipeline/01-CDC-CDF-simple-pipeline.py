...
# MAGIC To run this demo, just select the cluster `dbdemos-cdc-pipeline-alex_barreto` from the dropdown menu ([open cluster configuration](https://adb-830292400663869.9.azuredatabricks.net/#setting/clusters/0609-044627-s49d59vr/configuration)). <br />
# MAGIC *Note: If the cluster was deleted after 30 days, you can re-create it with `dbdemos.create_cluster('cdc-pipeline')` or re-install the demo: `dbdemos.install('cdc-pipeline')`*
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=830292400663869&notebook=%2F01-CDC-CDF-simple-pipeline&demo_name=cdc-pipeline&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fcdc-pipeline%2F01-CDC-CDF-simple-pipeline&version=1">
