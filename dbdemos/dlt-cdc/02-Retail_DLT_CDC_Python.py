...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=830292400663869&notebook=%2F02-Retail_DLT_CDC_Python&demo_name=dlt-cdc&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdlt-cdc%2F02-Retail_DLT_CDC_Python&version=1">
...
# MAGIC
# MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/b0294189-a6a1-4d88-9ad1-3cd476c6a764">Delta Live Table Pipeline for CDC</a>.
...
# MAGIC %md
# MAGIC ## Conclusion 
# MAGIC We now have <a dbdemos-pipeline-id="dlt-cdc" href="/#joblist/pipelines/b0294189-a6a1-4d88-9ad1-3cd476c6a764">our DLT pipeline</a> up & ready! Our `customers` table is materialize and we can start building BI report to analyze and improve our business. It also open the door to Data Science and ML use-cases such as customer churn, segmentation etc.
...
# MAGIC
# MAGIC <a href="/sql/dashboards/0010bba0-8066-4641-8790-2e12b95c3c48" target="_blank">Data Quality Dashboard</a>
