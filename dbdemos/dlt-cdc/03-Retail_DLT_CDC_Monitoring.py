...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=830292400663869&notebook=%2F03-Retail_DLT_CDC_Monitoring&demo_name=dlt-cdc&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdlt-cdc%2F03-Retail_DLT_CDC_Monitoring&version=1">

# COMMAND ----------

# MAGIC %md 
# MAGIC ### A cluster has been created for this demo
# MAGIC To run this demo, just select the cluster `dbdemos-dlt-cdc-alex_barreto` from the dropdown menu ([open cluster configuration](https://adb-830292400663869.9.azuredatabricks.net/#setting/clusters/0609-044751-5b9zy4q8/configuration)). <br />
...
# MAGIC
# MAGIC We can start creating our first <a href="/sql/dashboards/0010bba0-8066-4641-8790-2e12b95c3c48" target="_blank">DBSQL Dashboard</a> monitoring our data quality & DLT pipeline health.
