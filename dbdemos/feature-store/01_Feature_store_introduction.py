...
# MAGIC To run this demo, just select the cluster `dbdemos-feature-store-alex_barreto` from the dropdown menu ([open cluster configuration](https://adb-830292400663869.9.azuredatabricks.net/#setting/clusters/0609-044437-fdf1ex2j/configuration)). <br />
