...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=830292400663869&notebook=%2F03-Data-Analysis-BI-Warehousing%2F03-Data-Analysis-BI-Warehousing-patient-readmission&demo_name=lakehouse-hls-readmission&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-hls-readmission%2F03-Data-Analysis-BI-Warehousing%2F03-Data-Analysis-BI-Warehousing-patient-readmission&version=1">
...
# MAGIC %md
# MAGIC
# MAGIC Open the <a href="/sql/dashboards/5303e4c7-2107-4a6b-89e7-cf892d90b79f" target="_blank">Cohort patient analysis Dashboard</a> to start reviewing our cohort data.
