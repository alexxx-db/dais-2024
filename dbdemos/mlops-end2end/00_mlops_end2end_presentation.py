...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=830292400663869&notebook=%2F00_mlops_end2end_presentation&demo_name=mlops-end2end&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F00_mlops_end2end_presentation&version=1">
...
# MAGIC
# MAGIC Ultimately, we will be able to build a [complete DBSQL Churn Dashboard](/sql/dashboards/d0bbec77-ddbf-4e53-9401-0d9001319533-churn-prediction-dashboard---universal?o=1444828305810485#) containing all our customer & churn information!
