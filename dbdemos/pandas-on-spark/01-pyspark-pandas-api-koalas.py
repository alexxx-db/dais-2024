...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=830292400663869&notebook=%2F01-pyspark-pandas-api-koalas&demo_name=pandas-on-spark&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fpandas-on-spark%2F01-pyspark-pandas-api-koalas&version=1">

# COMMAND ----------

# MAGIC %md 
# MAGIC ### A cluster has been created for this demo
# MAGIC To run this demo, just select the cluster `dbdemos-pandas-on-spark-alex_barreto` from the dropdown menu ([open cluster configuration](https://adb-830292400663869.9.azuredatabricks.net/#setting/clusters/0609-044445-2vw3vd0s/configuration)). <br />
# MAGIC *Note: If the cluster was deleted after 30 days, you can re-create it with `dbdemos.create_cluster('pandas-on-spark')` or re-install the demo: `dbdemos.install('pandas-on-spark')`*
