...
// MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=830292400663869&notebook=%2Fscala%2F02-Delta-session-SILVER-scala&demo_name=streaming-sessionization&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fstreaming-sessionization%2Fscala%2F02-Delta-session-SILVER-scala&version=1">

// COMMAND ----------

// MAGIC %md 
// MAGIC ### A cluster has been created for this demo
// MAGIC To run this demo, just select the cluster `dbdemos-streaming-sessionization-alex_barreto` from the dropdown menu ([open cluster configuration](https://adb-830292400663869.9.azuredatabricks.net/#setting/clusters/0609-044609-jgbm647d/configuration)). <br />
