...
# Model info
UC_MODEL_NAME = "ift-meta-llama-3-8b-instruct-8xxldk" #"<FILL_IN>" # Name of model registered to Unity Catalog by instructor from M02_01, e.g. "ift-mistral-7b-instruct-v0-2-y1ikgx"
