...
course_config = CourseConfig(course_code = "gen",
                             ...
                             supported_dbrs = ["14.3.x-cpu-ml-scala2.12", "14.3.x-gpu-ml-scala2.12", "15.2.x-cpu-ml-photon-scala2.12", "15.3.x-gpu-ml-scala2.12", "15.3.x-cpu-ml-scala2.12"],
                             expected_dbrs = "{{supported_dbrs}}")


lesson_config = LessonConfig(name = None,
                             create_schema = False,
                             create_catalog = False, ## originally True 
                             requires_uc = True,
