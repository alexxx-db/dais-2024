...
# MAGIC %pip install --quiet databricks-sdk==0.24.0 mlflow==2.14.1 unstructured==0.13.7 sentence-transformers==3.0.1 torch==2.3.0 transformers==4.40.1 accelerate==0.27.2 databricks-vectorsearch
...
VS_ENDPOINT = f"vs_endpoint_alexxx_{(sum(ord(char) for char in DA.unique_name('_')) % 9) + 1}"
print(VS_ENDPOINT)
