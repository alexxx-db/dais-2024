...
predictions_df = eval_df.withColumn("generated_title", get_prediction_udf(F.struct(F.col("inputs").alias("prompt"), F.lit(max_tokens).alias("max_tokens"), F.lit(temperature).alias("temperature"))))
