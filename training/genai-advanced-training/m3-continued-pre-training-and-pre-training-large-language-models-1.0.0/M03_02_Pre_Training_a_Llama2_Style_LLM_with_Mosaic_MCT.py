...
# MAGIC
# MAGIC For any solutions that require pre-training, we will need to use Mosaic Classic Training (MCT) APIs. In this demo, we will cover how to create a pre-training run with Databricks MCT.
...
# MAGIC
# MAGIC If you are training models with [Composer](https://docs.mosaicml.com/projects/composer/en/stable/), then the `command` field is where you will write
# MAGIC your [Composer launch command](https://docs.mosaicml.com/projects/composer/en/stable/trainer/using_the_trainer.html#distributed-training).
# MAGIC
# MAGIC #### `compute` 
# MAGIC
...
# MAGIC #### `integrations`
# MAGIC
# MAGIC We support many [Integrations](https://docs.mosaicml.com/projects/composer/en/stable/composer_model.html#integrations) to customize aspects of both the run setup and environment.
# MAGIC
...
# MAGIC
# MAGIC   callbacks:
# MAGIC     hf_checkpointer: ## This is needed to log to Databricks UC along with the mlflow logger
...
# MAGIC
# MAGIC Documentation is linked [here](https://docs.mosaicml.com/projects/mcli/en/latest/).
# MAGIC
...
# MAGIC
# MAGIC Mosaic AI CLI documentation is linked [here](https://docs.mosaicml.com/projects/mcli/en/latest/).
