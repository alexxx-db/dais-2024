...
# MAGIC
# MAGIC Databricks AutoML supports experimentation via the UI and the API. Thus, **in the first section of this demos we will demonstrate how to create an experiment using the UI**. Then, we will show to how to create the same experiment via the API.
...
# MAGIC <img src = "https://files.training.databricks.com/images/automl-create-experiment-v1.png" width = 1000>
# MAGIC
...
# MAGIC
# MAGIC
# MAGIC 5. Select the **catalog > schema > `customers_churb` table**, which was created in the previous step, as the input training dataset.
# MAGIC
...
# MAGIC
# MAGIC <img src = "https://files.training.databricks.com/images/automl-input-fields-v1.png" >
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC In this section we will use AutoML API to start and AutoML job and retreive the experiment results.
